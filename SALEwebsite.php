    ...
    <header>
        <div class="container">
            <div class="header-content">
                <div class="logo">🛍️ Sale Linh Tinh</div>
                <div class="nav-menu">
...
<div id="chat-box" style="position: fixed; bottom: 70px; right: 20px; width: 300px; height: 400px; background: white; border: 1px solid #ccc; display: none; z-index: 1000;">
    ...
    <form method="post" style="display: flex;">
        ...
        ?>
        <p style="text-align: center; margin-top: 2rem;">Bạn sẽ được chuyển về <strong>trang chủ</strong> sau <span id="countdown">5</span> giây...</p>
        <script>
            let seconds = 5;
...
<?php endif; ?>
            <div class="section">
                ...
                <p>Chào mừng <?php echo isset(($_SESSION['username'])) ? htmlspecialchars($_SESSION['username']): 'bạn'; ?> đến với hệ thống!</p>
                <?php
                $user_id = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : null;
    ...
    <footer>
        <div class="container">
            ...
            <p>Liên hệ: 0123.456.789 | Email: salelinhtinh@shop.vn</p>
        </div>
    </footer>
